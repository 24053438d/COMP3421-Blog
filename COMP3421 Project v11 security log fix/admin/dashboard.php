...
// Get approved comments for management
$stmt = $db->prepare("SELECT c.*, u.username, p.title as post_title 
                     FROM comments c 
                     LEFT JOIN users u ON c.user_id = u.id 
                     LEFT JOIN posts p ON c.post_id = p.id
...
<ul class="nav nav-tabs mb-4" id="adminTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="approved-comments-tab" data-bs-toggle="tab" data-bs-target="#approved-comments" type="button" role="tab">
            Approved Comments (<?php echo count($approved_comments); ?>)
        </button>
    </li>
</ul>
...
<div class="tab-content" id="adminTabsContent">
    ...
    <div class="tab-pane fade" id="approved-comments" role="tabpanel">
        <h3>Manage Approved Comments</h3>
        <?php if (empty($approved_comments)): ?>
            <p>No approved comments to manage.</p>
        <?php else: ?>
            <div class="list-group">
